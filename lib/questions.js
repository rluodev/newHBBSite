...
const schoolsList = caSchools.map(school => school.city ? `${school.school} - ${school.city}` : school.school ?? '');
 ...
 export const questions = {
    ...
    dietaryRestrictions: {
        ...
        required: true,
        description: 'Select \'None\' if you don\'t have any allergies/restrictions.',
        help: '',
        verify: () => true
    },
    school: {
    ...
    discord: {
        ...
        description: 'We\'ll use this to verify your discord account on our server. If you don\'t have an account, please enter "None".',
        verify: disc => /^([a-zA-Z0-9]+#[0-9]{4}|none)$/gmi.test(disc)
    },
    extra: {
